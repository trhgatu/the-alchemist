...
export function TheAlchemistCard() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-neutral-400/5 rounded-full blur-[80px] group-hover:bg-neutral-400/10 transition-colors duration-1000"
      />
      <div className="relative w-[75%] h-[75%] z-10 group animate-float">
        <div
          className="absolute inset-0 bg-slate-400/20 rounded-full blur-xl scale-90 opacity-0 group-hover:opacity-100 group-hover:scale-125 transition-all duration-700 ease-out -z-10 mix-blend-multiply"
        />
        <div
        ...
        >
          ...
          <div className="absolute inset-0 opacity-20 mix-blend-overlay pointer-events-none bg-[url('/assets/images/noise.png')]" />
