    ...
    return (
        <section ref={containerRef} id="tech-arsenal" className="relative bg-[#f0f0f0] w-full min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="dragon-layer absolute inset-0 flex items-center justify-center pointer-events-none z-0 opacity-10 select-none">
                <Image src="/assets/images/medieval_dragon.png" alt="Dragon" width={1000} height={1000} className="object-contain w-[80%] h-[80%]" />
            </div>
            ...
            <div className="relative z-20 w-full py-20 max-w-7xl px-6 text-center">
                ...
                <TooltipProvider delayDuration={0}>
                    <div ref={gridRef} className="flex flex-wrap justify-center gap-12 max-w-5xl mx-auto py-10 px-4 perspective-1000">
                        {SKILLS.map((skill) => (
                            <div
                                key={skill.name}
                            ...
                            >
                                <Tooltip>
                                    ...
                                    <TooltipContent side="bottom" className="bg-white/90 text-neutral-800 border-amber-100 backdrop-blur-md shadow-xl font-space-mono text-xs px-3 py-1.5 translate-y-4">
                                        <p className="font-semibold tracking-wider font-kings text-lg text-amber-600">{skill.name}</p>
